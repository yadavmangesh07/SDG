...
const ImageCarousel = () => {
    return (
        <div className=' border-t-white    rounded  relative overflow-hidden' style={{backgroundColor:'rgba(255, 255, 255, 0.2)'}} >
            ...
            >
                <div className='  border-3 border-green-500 border-green shadow-2xl  rounded text-center p-2 transition ease-in-out duration-300  hover:-translate-y-0.7 hover:scale-105 hover:shadow-black' style={{backgroundColor:'rgba(255, 255, 255, .8)'}}><FontAwesomeIcon icon={faPeopleGroup} style={{ color: "black", fontSize: '7rem', padding: '1rem' }} />
                ...
                <div className=' border-3 border-green-500 shadow-2xl rounded text-center p-2 transition ease-in-out duration-300  hover:-translate-y-0.7 hover:scale-105 hover:shadow-black' style={{backgroundColor:'rgba(255, 255, 255, .8)'}}><FontAwesomeIcon icon={faRecycle} style={{ color: "black", fontSize: '7rem', padding: '1.5rem' }} />
                ...
                <div className='border-3 border-green-500 shadow-2xl rounded text-center p-2 transition ease-in-out duration-300  hover:-translate-y-0.7 hover:scale-105 hover:shadow-black' style={{backgroundColor:'rgba(255, 255, 255, .8)'}}><FontAwesomeIcon icon={faShieldHalved} style={{ color: "black", fontSize: '7rem', padding: '1rem' }} />
                ...
                <div className=' border-3 border-green-500 shadow-2xl rounded text-center p-2 transition ease-in-out duration-300  hover:-translate-y-0.7 hover:scale-105 hover:shadow-black' style={{backgroundColor:'rgba(255, 255, 255, .8)'}}><FontAwesomeIcon icon={faEyeDropper} style={{ color: "black", fontSize: '7rem', padding: '1rem' }} />
